      ...
      <form ref={formRef}>
        ...
        <div>
          ...
          <select name="addRegion">
            ...
            <option value="ancienne-republique-yougoslave-de-macedoine">
            ...
            <option value="etats-federes-de-micronesie">
            ...
            <option value="georgie-du-sud-et-les-iles-sandwich-du-sud">
            ...
            <option value="iles-mariannes-du-nord">
              Îles Mariannes du Nord
            </option>
            <option value="iles-marshall">Îles Marshall</option>
            <option value="iles-mineures-eloignees-des-etats-unis">
            ...
            <option value="iles-vierges-des-etats-unis">
            ...
            <option value="papouasie-nouvelle-guinee">
            ...
            <option value="province-chinoise-de-taiwan">
              Province chinoise de Taiwan
            </option>
            <option value="qatar">Qatar</option>
            <option value="republique-arabe-syrienne">
            ...
            <option value="republique-de-moldavie">
            ...
            <option value="republique-islamique-d-iran">
              République islamique d'Iran
            </option>
            <option value="republique-populaire-democratique-de-coree">
              République populaire démocratique de Corée
            </option>
            <option value="republique-populaire-du-laos">
              République Populaire du Laos
            </option>
            <option value="republique-tcheque">République tchèque</option>
            <option value="republique-unie-de-tanzanie">
            ...
            <option value="saint-siege-cite-du-vatican">
            ...
            <option value="territoire-britannique-de-l-ocean-indien">
              Territoire britannique de l'océan Indien
            </option>
            <option value="territoire-francais-du-sud">
              Territoire Francais du Sud
            </option>
            <option value="territoires-palestiniens-occupes">
